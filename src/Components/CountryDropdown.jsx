...
const countryCallingCodes = {
  AF: "+93", AX: "+358", AL: "+355", DZ: "+213", AS: "+1-684", AD: "+376",
  AO: "+244", AI: "+1-264", AQ: "+672", AG: "+1-268", AR: "+54", AM: "+374",
  AW: "+297", AU: "+61", AT: "+43", AZ: "+994", BS: "+1-242", BH: "+973",
  BD: "+880", BB: "+1-246", BY: "+375", BE: "+32", BZ: "+501", BJ: "+229",
  BM: "+1-441", BT: "+975", BO: "+591", BA: "+387", BW: "+267", BV: "+47",
  BR: "+55", IO: "+246", BN: "+673", BG: "+359", BF: "+226", BI: "+257",
  KH: "+855", CM: "+237", CA: "+1", CV: "+238", KY: "+1-345", CF: "+236",
  ...
  MM: "+95", NA: "+264", NR: "+674", NP: "+977", NL: "+31", AN: "+599",
  NC: "+687", NZ: "+64", NI: "+505", NE: "+227", NG: "+234", NU: "+683",
  NF: "+672", MP: "+1-670", NO: "+47", OM: "+968", PK: "+92", PW: "+680",
  PS: "+970", PA: "+507", PG: "+675", PY: "+595", PE: "+51", PH: "+63",
  PN: "+870", PL: "+48", PT: "+351", PR: "+1-787", QA: "+974", RE: "+262",
  ...
  ES: "+34", LK: "+94", SD: "+249", SR: "+597", SJ: "+47", SZ: "+268",
  SE: "+46", CH: "+41", SY: "+963", TW: "+886", TJ: "+992", TZ: "+255",
  TH: "+66", TL: "+670", TG: "+228", TK: "+690", TO: "+676", TT: "+1-868",
  TN: "+216", TR: "+90", TM: "+993", TC: "+1-649", TV: "+688", UG: "+256",
  UA: "+380", AE: "+971", GB: "+44", US: "+1", UM: "+1", UY: "+598",
  UZ: "+998", VU: "+678", VE: "+58", VN: "+84", VG: "+1-284", VI: "+1-340",
  WF: "+681", EH: "+212", YE: "+967", ZM: "+260", ZW: "+263",
};

const CountryDropdown = ({ value, onChange, inputId, ariaLabel }) => {
  const options = countryList().getData().map((c) => ({
    value: c.value,
    label: c.label,
    code: countryCallingCodes[c.value] || "",
  }));
  ...
  return (
    <Select
      options={options}
      value={options.find((c) => c.label === value || c.value === value) || null}
