...
const Footer = () => {
  ...
  return (
    <div className="bg-gray-100 rounded !mb-6 !px-6 md:!px-20 text-gray-800">
      ...
      {/* Contact Info Grid */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 border-t border-gray-300 text-center !p-6 place-items-start">
        {/* Wrap all three blocks inside this flex container on md screens */}
        <div className="md:col-span-2 lg:col-span-3 flex flex-col lg:flex-row items-center justify-center gap-6 w-full">
          {/* Achievements & Awards */}
          ...
          <div className="!py-4 w-full max-w-md">
            <h4 className="text-lg font-semibold !mb-2 text-[#6b1e1e]">
              Write Us
            </h4>
          ...
          <div className="!py-6 w-full max-w-md">
            <div className="flex flex-col items-center text-center">
              <h4 className="text-lg font-semibold !mb-4 text-[#6b1e1e]">
                Call Us
              </h4>
