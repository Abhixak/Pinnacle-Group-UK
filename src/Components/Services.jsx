...
const services = [
  {
    ...
    title: "Selling Property",
    description:
      "Based in Mohali, Punjab, we are one of the prominent real estate companies well-known for offering Selling Property Services for different types of properties.",
    image: SellingImg,
  },
  {
    id: "buying",
